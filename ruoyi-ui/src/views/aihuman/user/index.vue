    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['aihuman:user:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['aihuman:user:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listUser, getUser, delUser, addUser, updateUser } from "@/api/aihuman/user";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('aihuman/user/export', {
        ...this.queryParams
